...
const selectedWork: ISelectedWork[] = [
  {
    ...
    href: LINKS.realai,
    body:
      "Fundrise's flagship AI product, taken from early prototype through " +
      'public launch and still under active development; built on Next.js, ' +
      'TypeScript, and Vercel. An agent harness with MCP servers, prompt and ' +
      'context architecture, and a suite of tools for LLMs to produce ' +
      'high-quality real estate analysis.'
  },
  {
    kind: 'Product · 0→1',
    title: 'Equitize',
    body:
      "Fundrise's private secondary-market securities platform, shipped from " +
      'concept to launch and scaled to millions in transaction volume. ' +
      'Concept, prototype, architecture, and implementation — then operating ' +
      'the platform.'
  },
  {
    kind: 'Infrastructure',
    ...
    body:
      ...
      'integration that processed 40k+ transactions in its first year, ' +
      'automated KYC for every user, and automated transfer-agent ' +
      'reconciliation replacing a manual process.'
  },
  {
    kind: 'Open source',
    title: 'Spring AI — Anthropic integration',
    href: LINKS.springAiPulls,
    body:
