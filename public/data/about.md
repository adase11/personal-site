...
AI—enabled products — including [RealAI](https://realai.com) — and still contributing on a daily basis. I've been at Fundrise since 2019 and over that them have been working with the team to help build a better financial system for the individual.

Most of what I've done has been zero—to—one. [RealAI](https://realai.com) went from an early prototype to a
launched product; before that, Equitize went from a concept to the private—securities platform. The pattern is usually the same — talk through the idea with the people who want it, build a
proof of concept quickly enough that we can debate concepts with something tangible, then take the parts that survive
into production and own them once they're carrying live traffic and real money.

Underneath all of it is a decade of development work in regulated domains: ACH processing handling
$1B+ a year, a [Stripe](https://stripe.com) debit funding integration, KYC and investment approval
workflows, share issuance and reconciliation, and insurance rating. That background is why I'm careful about evaluation and
...
Before Fundrise I spent three years at [Travelers](https://travelers.com) working on proprietary software, rating
systems, and machine learning pipelines. I have an M.S. in Computer Science from
[Towson University](https://www.towson.edu) and a B.S. in Information Systems from [The University of Maryland](https://umd.edu).
